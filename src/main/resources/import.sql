...
INSERT INTO QRTZ_TRIGGERS
(SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP, JOB_NAME, JOB_GROUP, DESCRIPTION, NEXT_FIRE_TIME, PREV_FIRE_TIME, PRIORITY, TRIGGER_STATE, TRIGGER_TYPE, START_TIME, END_TIME, CALENDAR_NAME, MISFIRE_INSTR, JOB_DATA)
VALUES ('scheduler-name-03', 'trigger-name-03', 'trigger-group-03', 'job-name-03', 'job-group-03', 'description', 1530543600000, -1, 0, 'WAITING', 'CRON', 1530543600000, 0, null, 0, null);
...
INSERT INTO QRTZ_CRON_TRIGGERS
(SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP, CRON_EXPRESSION, TIME_ZONE_ID)
VALUES ('scheduler-name-02', 'trigger-name-02', 'trigger-group-02', '0 0 0 1/1 * ? *', 'Asia/Seoul');
